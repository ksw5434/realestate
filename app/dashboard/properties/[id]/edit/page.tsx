...
export default function EditPropertyPage() {
  ...
  useEffect(() => {
    const checkAuthAndLoadProperty = async () => {
      try {
        ...
        if (id) {
          ...
          if (result.success && result.property) {
            ...
            setFormData({
              ...
              hasBasicOptions: property.has_basic_options || false,
              ...
              descriptions:
                property.descriptions && property.descriptions.length > 0
                  ...
                  : [""],
              zonecode: "", // 우편번호는 별도로 저장하지 않으므로 빈 문자열
              address: property.address || "",
              detailAddress: "", // 상세 주소는 별도로 저장하지 않으므로 빈 문자열
              ...
              financialInfo: property.financial_info || {
                acquisitionTax: "",
                acquisitionTaxNote: "",
                brokerageFeeSale: "",
                brokerageFeeRent: "",
        ...
        console.error("권한 확인 및 데이터 로드 중 오류:", err);
  ...
  // 로딩 중이거나 권한이 없으면 표시
  if (isCheckingAuth || isLoadingProperty) {
    return (
